        ...
        <div className="flex flex-wrap gap-4">
          {links.map((link) => (
            <Link
              key={link}
              href={`/example/${link}`}
              className="hover:bg-primary/10 flex items-center justify-center gap-2 rounded-md border border-border bg-accent px-2.5 py-1.5 shadow-sm transition-all hover:border-primary hover:shadow-md"
            >
